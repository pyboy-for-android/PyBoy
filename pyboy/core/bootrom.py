...
class BootROM:
    def __init__(self, bootrom_file, cartridge_cgb):
        if bootrom_file is None:
            ...
            rom = "../../../../resources/rom/bootrom_cgb.bin" if cartridge_cgb else "../../../../resources/rom/bootrom_dmg.bin"
            bootrom_file = os.path.join(os.path.dirname(os.path.realpath(__file__)), rom)
